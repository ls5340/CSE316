...
export default class Top5View {
    ...
    appendListToView(newList) {
        ...
        */
        ...
        listName.setAttribute("id", "list-card-text-" + newList.id);
        listName.setAttribute("class", "list-card-text");
        listName.setAttribute("value", newList.name);
        listName.setAttribute("readonly", true);
        listName.setAttribute("size", 17);
